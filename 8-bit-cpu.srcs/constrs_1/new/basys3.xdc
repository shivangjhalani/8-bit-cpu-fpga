...
# Connects to Button Right (BTNR - Pin T17) for Single Step Clock
set_property -dict { PACKAGE_PIN T17 IOSTANDARD LVCMOS33 } [get_ports btn_step]
# Connects to Button Down (BTND - Pin U17) for Continuous Run Clock
set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports btn_run]
